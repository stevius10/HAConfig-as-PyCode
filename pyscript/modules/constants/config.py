...
CFG_LOG_ARCHIV_SIZE = 8196
CFG_LOG_ARCHIV_SUFFIX = "2"

CFG_FILE_SETTINGS_IO_RETRY = 4
...
CFG_NOTIFICATION_TARGET_DEFAULT = "default"
CFG_NOTIFICATION_ID_LENGTH = 10
...
CFG_PATH_DIR_HOME_LOCAL = f"{CFG_PATH_DIR_CONFIG}/.storage/home"
...
CFG_PATH_DIR_PY_LOGS_DATA = f"{CFG_PATH_DIR_LOG}/data"
...
CFG_SYSTEM_ENVIRONMENT = {
  "BASHRC_PATH": CFG_PATH_DIR_HOME_LOCAL, 
  "ZDOTDIR": CFG_PATH_DIR_HOME_LOCAL,
  
  "PYTHONDONTWRITEBYTECODE": "1"
}

CFG_SYSTEM_FILES = { **SEC_SYSTEM_FILES, 
  f"{CFG_PATH_DIR_FILES}/.rc": f"{CFG_SYSTEM_ENVIRONMENT['BASHRC_PATH']}/.bashrc",
  f"{CFG_PATH_DIR_FILES}/.rc": f"{CFG_SYSTEM_ENVIRONMENT['ZDOTDIR']}/.zshrc"
}
