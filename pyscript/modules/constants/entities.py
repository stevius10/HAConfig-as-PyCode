...
SCRIPT_OFF_ENTITIES_AIR = [ "humidifier.luftbefeuchter", "fan.wz_ventilator", "fan.sz_ventilator", "fan.wz_luft", "fan.sz_luft", "switch.wz_luftung", "switch.sz_luftung" ]
SCRIPT_OFF_ENTITIES_HEATING = [ "clima.wz_heizung", "clima.sz_heizung", "clima.k_heizung" ]
SCRIPT_OFF_ENTITIES_MEDIA= [ "media_player.bad", "media_player.kueche", "media_player.schlafzimmer", "media_player.wohnzimmer", "media_player.uberall" ]
SCRIPT_OFF_ENTITIES_LIGHT = [ "light.wz_beleuchtung", "light.sz_beleuchtung", "light.k_beleuchtung", "light.g_beleuchtung" ]
SCRIPT_OFF_ENTITIES = [ "switch.bett", "switch.sofa", "switch.heizdecke" ]
SCRIPT_OFF_ENTITIES_TV = [ "media.wz_fernseher", "media.sz_fernseher" ]
