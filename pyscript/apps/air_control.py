...
@state_trigger([f"{expr(entity['fan'], STATE_ON, previous=STATE_OFF)} and {expr(f'{entity['fan']}.percentage', SET_AIR_CONTROL_CLEAN_MODE_PERCENTAGE, comparator='>=')}" for entity in entities.values()])
