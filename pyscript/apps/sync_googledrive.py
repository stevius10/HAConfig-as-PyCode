...
class Drive():
  ...
  def __init__(self, service_google_drive_credentials_file):
    try:
      ...
      Logs("Google Drive service initialized successfully.")
    except Exception as e:
      Logs(f"Error initializing Google Drive service: {e}")
      raise e
...
async def service_googledrive_sync():
  try:
    ...
    log.info(logfile.finished())
  except Exception as e:
    log.error("Error synchronizing Google Drive: {}", str(e))